    ...
    <main id="main">
      ...
      <section class="ios-click home-section home-fade home-full-height" id="home">
        <div class="hero-slider">
          <ul class="slides">
            <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url(&quot;assets/images/bdsm/br_bk_02.png&quot;);">
      ...
      <div class="main">
            ...
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <p class="article">
                  ...
                  ※極度の泥酔状態の方、薬物使用者、店内での客引き行為を目的とする同業者の方の入店、その他当店が不適切と
                  判断したお客様のはお断りさせて頂きます。                  
                </p>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <p>※男性のお客様にのみ、1時間以降は30分ごとに￥2,000の延長料金を頂いております。</p>
                <table class="sys-table">
            ...
            <div class="row multi-columns-row">
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  ...
                  <h4 class="shop-item-title font-alt"><a href="#">Girl_01(25)</a></h4>T170
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  ...
                  <h4 class="shop-item-title font-alt"><a href="#">Girl_02(20)</a></h4>T160
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  ...
                  <h4 class="shop-item-title font-alt"><a href="#">Girl_03(30)</a></h4>T150
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  ...
                  <h4 class="shop-item-title font-alt"><a href="#">Girl_04(35)</a></h4>T165
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  ...
                  <h4 class="shop-item-title font-alt"><a href="#">Girl_05(25)</a></h4>T155
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  ...
                  <h4 class="shop-item-title font-alt"><a href="#">Girl_06(30)</a></h4>T140
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
                  ...
                  <h4 class="shop-item-title font-alt"><a href="#">Girl_07(25)</a></h4>T180
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="shop-item">
        ...
        <section id="schedule" class="ios-click module module-video bg-dark-30" data-background="">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title-adj">SCHEDULE</h2>
              </div>
              <div class="col-sm-6">
        ...
        <section id="BBS" class="ios-click module">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title-adj">BBS</h2>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-12 mb-20 font-custom">
                <p class="">住所：〒532-0024 大阪府大阪市淀川区十三本町２丁目１−１７</p>
              </div>
        ...
        <div class="ios-click module-small bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-sm-3">
                <div class="widget">
                  <h5 class="widget-title font-alt">SM & Fetish Bar BR</h5>
                  <p>〒532-0024 大阪府大阪市淀川区十三本町２丁目１−１７ 電話：</p>
                  <p>Phone No: 06-6885-9997</p>From outside of Japan: +81 6 6885 9997
        ...
        <footer class="ios-click footer bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2018&nbsp;<a href="index.html">SM & Fetish Bar BR</a>, All Rights Reserved</p>
              </div>
              <div class="col-sm-6">
